    ...
    <section className="createForm">
      ...
      <form className="form" onSubmit={onSubmit}>
        ...
        <div className="form-group">
          ...
          <input type="checkbox" name="Yes" id="covid_vaccination_status" onChange={onChange} />
          <label htmlFor="covid_vaccination_status">Yes</label>
          <input type="checkbox" name="No" id="covid_vaccination_status" onChange={onChange} />
          <label htmlFor="covid_vaccination_status">No</label>
        </div>
        <div className="form-group">
        ...
        <div className="form-group">
          ...
          <div className="form-group__checkboxes">
            <input type="checkbox" name="dance" id="interests_hobbies" onChange={onChange} />
            <input type="checkbox" name="sports" id="interests_hobbies" onChange={onChange} />
          </div>
        </div>
        <div className="form-group">
        ...
        <div className="form-group">
          ...
          <input type="radio" name="drinking" id="drinking" onChange={onChange} />
          <input type="radio" name="drinking" id="drinking" onChange={onChange} />
        </div>
        <div className="form-group">
          <label htmlFor="smoking">Smoker</label>
            <input type="radio" name="smoking" id="smoking" onChange={onChange} />
            <input type="radio" name="smoking" id="smoking" onChange={onChange} />
        </div>
        <div className="form-group">
          <label htmlFor="kids">Drinker</label>
            <input type="radio" name="kids" id="kids" onChange={onChange} />
            <input type="radio" name="kids" id="kids" onChange={onChange} />
            <input type="radio" name="kids" id="kids" onChange={onChange} />
            <input type="radio" name="kids" id="kids" onChange={onChange} />
        </div>
